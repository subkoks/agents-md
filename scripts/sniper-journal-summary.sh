...
if [[ "$OUTPUT_FORMAT" == "json" ]]; then
  ...
  # Table format. Pass $DATE via --arg so it cannot break out of the
  # jq program and inject additional filters/strings when a caller
  # supplies an unusual DATE argument.
