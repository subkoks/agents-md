...
- Unified canonical stack: `src/gotcha.md` + `src/gotcha-lean.md` with generated `dist/rules/*`
- Comprehensive validation and strict drift checks (`make check`, governance pipeline)
- Cursor lean + full artifacts (`cursor.lean.md`, `cursor.md`) and `make sync-cursor`
