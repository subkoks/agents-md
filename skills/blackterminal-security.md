...
| Markdown `![](https://attacker.example)` from untrusted | Exfil image | Sanitize, block external image hosts |
...
- **vulnerability-taxonomies.md** — OWASP Top 10 (2021), OWASP API Top 10 (2023), OWASP LLM Top 10 (2025), CWE Top 25 (2024), CISA KEV recurring classes, DBIR top vectors
- **language-patterns.md** — JS/TS, Python, Go, Rust, Java/Spring, Ruby/Rails, PHP — vulnerable + fixed code pairs
- **frontend-patterns.md** — React, Next.js (Server Actions, middleware, hydration), Vue, Svelte, browser-specific
...
- **case-studies.md** — Log4Shell, Spring4Shell, MOVEit, XZ backdoor, Polyfill.io, Snowflake, Ivanti, regreSSHion, Next.js CVEs, tj-actions supply chain, recent agent CVEs
- **tooling.md** — Semgrep, CodeQL, Snyk, Trivy, Gitleaks, OSV, govulncheck, Brakeman, Checkov, kube-bench
